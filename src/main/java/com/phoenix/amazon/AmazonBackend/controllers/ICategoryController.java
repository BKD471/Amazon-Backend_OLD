...
public interface ICategoryController {
    ...
    ResponseEntity<CategoryDto> createCategory(@RequestPart("categoryDto") @Valid CategoryDto categoryDto,
                                           @RequestPart("coverImage") MultipartFile coverImage) throws UserNotFoundExceptions, UserExceptions, BadApiRequestExceptions, IOException;
    ...
    ResponseEntity<PageableResponse<CategoryDto>> getAllCategories(@RequestParam(value = "pageNumber", defaultValue = "1", required = false) final int pageNumber,
                                                      ...
                                                      @RequestParam(value = "sortDir", defaultValue = "asc", required = false) final String sortDir) throws UserNotFoundExceptions, UserExceptions, BadApiRequestExceptions, IOException;
